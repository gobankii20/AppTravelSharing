...
class ProfileDriverFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_profile_driver, container, false)
    ...
    private fun fetchData(list: List<ModelCreateUser>) {
        ...
        if (list[0].image_card!!.isNotEmpty()) {
            Utils.setImageView(
                requireContext(),
                Utils.convertBase64ToImage(list[0].image_card!!),
                ivProfile
            )
        }
